...
const Contact = () => {
  return (
    ...
    <section id='contact' className='z-50 bg-white font-Poppins  relative py-10 px-5 md:px-0'>
      <div className='mb-16 max-w-7xl mx-auto'>
        ...
        <div className='flex flex-col md:flex-row justify-between items-center'>
          <div className='md:w-1/2 mb-8 ml-2 md:mb-0'>
            <p className='mb-4text-black'>I'm always open to new opportunities and collaboration. Feel free to reach out!</p>
          ...
          <form className='w-full md:w-1/3 bg-gray-100 rounded-lg border border-red-300 shadow-lg  p-10 mr-10'>
            ...
            <button className='bg-[#00ffee] text-purple px-3 py-2 rounded-lg shadow-md shadow-black'>Send Message</button>
          </form>
        </div>
      </div>
    </section>
